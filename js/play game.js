...
function cellClicked(cell) {
    ...
    if (!gIsManualMines) {
        ...
        if (gBoard[i][j].cellValue === MINE && gIsFirstClick) {  //first click - the cell is mine
            firstClick(cell)
